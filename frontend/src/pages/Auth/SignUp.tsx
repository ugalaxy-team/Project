...
const SignUp = () => {
    ...
    return <form onSubmit={handleSignUp}>
        ...
        <input onChange={handleUpdate} autoComplete="username" type="text" name="displayName" id="displayName" value={formData.displayName} />
        <input onChange={handleUpdate} autoComplete="email" type="email" name="email" id="email" value={formData.email} />
        {formErrors.email && <p>{formErrors.email}</p>}
        <input onChange={handleUpdate} autoComplete="new-password" type="password" name="password" id="password" value={formData.password} />
