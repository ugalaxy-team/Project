              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <FieldInput
                      {...register(`members.${index}.telegram`)}
                      placeholder={t("step_2.placeholders.telegram")}
                      hasError={!!memberErrors?.telegram}
                    />
                  ...
                  <div>
                    ...
                    <FieldInput
                      ...
                      placeholder={t("step_2.placeholders.institution")}
                      hasError={!!memberErrors?.institution}
                    />
